...
xpt = ['DIQ_J.XPT', 'BMX_J.XPT', 'PAQ_J.XPT',
       'GHB_J.XPT', 'DPQ_J.XPT', 'INQ_J.XPT']
...
df['finflg'] = df.eval(
    "LBXGH >= 6.5 or DIQ010 == 1 or DIQ050 == 1 or DIQ070 == 1").astype(int)
...
df3 = df2.loc[:, ['RIAGENDR', 'RIDAGEYR', 'RIDRETH1', 'DMDEDUC2', 'DMDMARTL',
                  'BMXBMI', 'DPQ020', 'INDFMMPI', 'LBXGH', 'METS', 'QMETS', 'finflg']]

df3['RIAGENDR'] = df2['RIAGENDR'].map({1: 'Male', 2: 'Female'})
df3['RIDRETH1'] = df2['RIDRETH1'].map(
